...
CREATE TABLE IF NOT EXISTS accepted_document_type (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS reader (
    ...
    document_identification CHAR(30) NOT NULL UNIQUE,
    FOREIGN KEY (document_type_id)
        REFERENCES accepted_document_type (id)
        ON UPDATE CASCADE
        ON DELETE RESTRICT
);
...
CREATE INDEX IF NOT EXISTS idx_reader_document_type_id ON reader (document_type_id);
